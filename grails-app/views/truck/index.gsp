...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            ...
            <section class="row">
                <div id="list-truck" class="col-12 content scaffold-list" role="main">
                    <h1><g:message code="default.list.label" args="[entityName]" /></h1>
                    <g:if test="${flash.message}">
                        <div class="message" role="status">${flash.message}</div>
                    </g:if>
                    <f:table collection="${truckList}" />

                    <g:if test="${truckCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${truckCount ?: 0}" />
                    </div>
                    </g:if>
                </div>
            </section>
